import type { Route } from "./+types/dos.zip";
import { streamDosBundle, getBundleEtag, bundleVersionFromEtag } from "../lib/bundle";
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const { body, etag: bodyEtag, size } = await streamDosBundle();
  return new Response(body, {
    status: 200,
    headers: {
      "Content-Type": "application/octet-stream",
      "Content-Disposition": 'inline; filename="dos.zip"',
